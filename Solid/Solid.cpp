...
// Solid.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CSolidApp, CWinAppEx)
	//ON_COMMAND(ID_APP_ABOUT, &CSolidApp::OnAppAbout)
...
CSolidApp::CSolidApp()
{
	...
	SetAppID(_T("Solid.AppID.NoVersion"));

	// TODO: agregar aquí el código de construcción,
	// Colocar toda la inicialización importante en InitInstance
}

// El único objeto CSolidApp

CSolidApp theApp;


// Inicialización de CSolidApp

BOOL CSolidApp::InitInstance()
{
...
// Controladores de mensaje de CSolidApp
...
void CSolidApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Métodos para cargar o guardar personalizaciones de  CSolidApp

void CSolidApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSolidApp::LoadCustomState()
{
}

void CSolidApp::SaveCustomState()
{
}
